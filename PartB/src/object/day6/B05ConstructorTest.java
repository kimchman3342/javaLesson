...
public class B05ConstructorTest {
    public static void main(String[] args) {
        ...
        System.out.println("\tmy4 field3 : " + Arrays.toString(my4.getField3()));
         ...
         // 기본 생성자와 setter가 없는 MyClass5 객체를 생성합니다.
        ...
        System.out.println("\tmy5 field3 : \n" + my5.getField3());

        MyClass3 test = new MyClass3();
        test.setField1("파이썬");
        test.setField2(9999);
        test.setField3(new double[] {1.2,34.56,123.45});
        // 기본 생성자는 set 메소드로 직접 값을 초기화하는 것이 조금 불편합니다.
        //              -> 초기화를 위해서는 커스텀 생성자가 좋습니다.

        // 결론 : MyClass3과 같이 생성자 메소드가 직접 정의된 것이 없으면 기본생성자만 사용 가능합니다.
        //                                                      ㄴ 기본생성자가 생략되어 있는 상태입니다.
        //       MyClass5와 같이 커스텀 생성자 메소드가 하나라도 정의되어 있으면 기본생성자는 사용 못합니다.
