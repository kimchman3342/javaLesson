 ...
 * Scanner 클래스와 같이 java.util 등 다른 패키지에 속한 클래스는 import를 해야합니다.
...
public class B08MathTest {
    ...
    System.out.println("최대값 max, 최소값 min 구하기 - 메소드 오버로딩");
    ...
    System.out.println("위의 메소드 이용해서 3개의 정수 34, 56, 12 의 최대값, 최소값 구하기");
    ...
    // Math 클래스에는 기본 수학 공식을 해결하는 메소드(제곱근, 지수, 반올림, 내림... 등)를 제공합니다.
  }
