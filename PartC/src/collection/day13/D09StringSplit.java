...
public class D09StringSplit {
    ...
    public static void main(String[] args) {
        ...
        for(Score temp : list) {
            System.out.println(temp);  //list.get(i)를 반복자로 실행
        }
    ...
    public static List<Score> makeList() {
        ...
        public static Score makeScore(String line){
            String[] temp = line.split(",");
            Score stu = new Score(temp[0], Integer.parseInt(temp[1].trim()),Integer.parseInt(temp[2].trim()), Integer.parseInt(temp[3].trim()));
