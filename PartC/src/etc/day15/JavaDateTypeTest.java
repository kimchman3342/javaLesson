 ...
 * 2) java.sql 패키지의 Date, Timestamp 클래스 : jdk 1.1 버전부터. 데이터 베이스와 연동되는 타입
 * 3) java.time 패키지의 LocalDate, LocalTime 클래스 : jdk 1.8 버전부터
...
public class JavaDateTypeTest {
    public static void main(String[] args) {
        ...
        System.out.println("--- 현재 시간을 ms로 구하는 방식은 모든 프로그래밍 언어에서 사용합니다. ---");
        ...
        System.out.println("\t54년 = " + df.format(oneyear*54) +"ms");
        System.out.println("\t55년 = " + df.format(oneyear*55) +"ms");
        ...
        System.out.println("=> private  생성자이고 객체를 만들어 전달해 주는 get instance() 메소드.");    
