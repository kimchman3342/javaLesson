...
public class D01TryCatchTest {
    public static void main(String[] args) {
        // 예외 처리 구문 : 비정상적인 종료에 대해 사용자에게 전달. 또는 이후의 명령을 계속 실행하도록 합니다.
        // NumberFormatException, ArrayIndexOutOfBoundsException 은 예외처리가 강제가 아닙니다.
        // 언체크 익셉션
        try {
        // 예외 가능성이 있는 명령문 작성하기
        indexException();   // numberException();
