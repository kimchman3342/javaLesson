 ...
 * 참고 : 오라클에서는 테이블, 컬럼명 등 식별자 이름에 쓸 수 있는 기호 _ , #, $
 * 
 * */
...
-- 7) 제약조건 제거 : 제약 조건은 변경은 없습니다. add와 drop만 있습니다.
...
-- ** alter table로 col1을 primary key로 변경해보세요. (나중에는 alter table로 fk추가도 할 수 있어야 합니다.)
