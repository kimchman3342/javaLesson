...
CREATE TABLE tbl_member (
	...
	join_date DATE default sysdate 	-- DEFAULT 는 기본 값 키워드. sysdate는 현재 날짜와 시간
						-- 가입날짜 , 날짜형식 : 날짜 패턴 문자열이 'yyyy-mm-dd' 자동으로 날짜형식 변환
